...
def _compute_default_rope_parameters(config=None, device=None, **rope_kwargs):
    """Default RoPE frequencies.

    transformers v5 removed the "default" entry from `ROPE_INIT_FUNCTIONS`;
    this reproduces the previous default computation (transformers v4
